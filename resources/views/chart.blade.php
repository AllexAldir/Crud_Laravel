@extends('layouts.app',[
	'module' => [
		'head' => [
			'link' =>[
				'plugins/jqvmap/jqvmap.min.css','plugins/icheck-bootstrap/icheck-bootstrap.min.css','plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css','plugins/fontawesome-free/css/all.min.css','plugins/overlayScrollbars/css/OverlayScrollbars.min.css','plugins/daterangepicker/daterangepicker.css','plugins/summernote/summernote-bs4.min.css'
			]
		],
		'body' => [
			'script' => [
				'plugins/jquery/jquery.min.js','plugins/jquery-ui/jquery-ui.min.js','plugins/bootstrap/js/bootstrap.bundle.min.js','plugins/chart.js/Chart.min.js','plugins/sparklines/sparkline.js','plugins/jqvmap/jquery.vmap.min.js','plugins/jqvmap/maps/jquery.vmap.usa.js','plugins/jquery-knob/jquery.knob.min.js','plugins/moment/moment.min.js',
				'/dist/js/pages/dashboard.js','dist/js/charts.min.js'
			]
		]
	]
]);
...
@section('content')
	...
	<div class="container-fluid">
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Média de vendas por mês</h5>
						...
						<div class="row">
							<div class="col-md-8">
								...
								<div class="chart">
									...
									<canvas id="salesChart" height="120" style="height: 180px; display: block; width: 680;" width="453" class="chartjs-render-monitor"></canvas>
								</div>
							</div>
							<div class="col-md-4">
								<p class="text-center">
		...
		{{--Segundo gráfico--}}
		{{-- <div class="card"  style="position: relative; height:40vh; width:30vw; margin: auto">
		...
		<script>
			...
			const grafico2 = document.getElementById('salesChart2');
					...
					<div class="card-body">
						<div class="tab-content p-0">
							<div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
								...
								<canvas id="revenue-chart-canvas" height="200" style="height: 300px; display: block; width: 576px;" width="384" class="chartjs-render-monitor"></canvas>
							</div>
			...
			{{-- <section class="col-lg-5 connectedSortable ui-sortable">
				<div class="card bg-gradient-primary">
					...
					<div class="card-body">
						<div id="world-map" style="height: 250px; width: 100%; position: relative; overflow: hidden; background-color: transparent;">
							<svg width="396.07" height="249.984">
								<g transform="scale(0.4130031282586027) translate(0, 6.1417754437347165)">
					...
					<div class="card-footer bg-transparent">
						<div class="row">
							<div class="col-4 text-center">
								<div id="sparkline-1">
									<canvas width="60" height="37" style="width: 80px; height: 50px;"></canvas>
								</div>
				...
				<div class="card bg-gradient-info">
					...
					<div class="card-body">
						...
						<canvas class="chart chartjs-render-monitor" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 396px;" width="264" height="166"></canvas>
					</div>
					<div class="card-footer bg-transparent">
						<div class="row">
							<div class="col-4 text-center">
								<div style="display:inline;width:60px;height:60px;">
									<canvas width="45" height="45" style="width: 60px; height: 60px;"></canvas>
												...
												<table class="table table-sm">
													...
													<tbody>
														<tr>
															...
															<td data-action="selectDay" data-day="09/01/2023" class="day active today">1</td>
														...
														<tr>
															...
															<td data-action="selectDay" data-day="09/28/2023" class="day">28</td>
